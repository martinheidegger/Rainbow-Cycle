...
// under the License. 
//  
package at.leichtgewicht.color.linear.rainbow {
	import at.leichtgewicht.color.linear.ILinearGradient;
	import at.leichtgewicht.color.util.RainbowToUint;
	 ...
	 */
	public class RainbowGradient extends EventDispatcher implements ILinearGradient {
		 ...
		 */
		public function RainbowGradient( saturation: Number, brightness: Number ) {
		...
		public function getColor( percentage: Number ): uint {
			return RainbowToUint( percentage, _saturation, _brightness );
		}
