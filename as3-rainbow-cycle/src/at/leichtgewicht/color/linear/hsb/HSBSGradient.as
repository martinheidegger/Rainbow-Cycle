...
package at.leichtgewicht.color.linear.hsb {
	 ...
	 */
	public class HSBSGradient extends EventDispatcher implements ILinearGradient {
		 ...
		 */
		public function HSBSGradient( hue: Number, brightness: Number ) {
			_hue = hue;
		...
		public function getColor( percentage: Number ): uint {
			return HSBtoUint( _hue, percentage, _brightness );
		}
